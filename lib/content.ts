  ...
  projects: {
    ...
    placeholders: [
      ...
      },
      {
        ...
        title: "更多项目正在展示",
        status: "持续更新",
        description: "更多项目正在整理与展示，新的实验会在这里逐步出现。",
      },
    ],
  },
  directory: {
...
const en: Copy = {
  ...
  projects: {
    ...
    placeholders: [
      ...
      {
        index: "03",
        title: "More projects on display",
        status: "UPDATING",
        description: "More projects are being prepared and will appear here as they take shape.",
      },
    ],
  },
  directory: {
